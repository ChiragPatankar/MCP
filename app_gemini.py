...
# MCP Models (keeping your existing models)
...
# MCP Authentication (keeping your existing auth)
...
async def process_mcp_request(
    ...
    try:
        ...
        # Fetch additional context (now using internal context building)
...
async def fetch_context(message: str, existing_context: Optional[Dict] = None) -> dict:
    """Build context for the query (replacing Glama.ai)"""
    context = {
        "timestamp": datetime.utcnow().isoformat(),
    ...
    # Add any internal context building logic here
    # For example, you could add FAQ matching, keyword extraction, etc.
    
    return context

async def process_with_gemini(message: str, context: dict, priority: str = "normal") -> str:
    """Process message with Google Gemini (replacing Cursor AI)"""
...
async def store_interaction(
    ...
    """Store interaction in database (keeping your existing function)"""
    try:
...
if __name__ == "__main__":
    ...
    print(f"🔧 Server: {mcp_settings.SERVER_NAME}")
